                    ...
                    <div className="lg:pr-4">
                        <div className="max-w-xl text-base leading-7 text-gray-700 lg:max-w-lg">
                            ...
                            <div className='flex max-sm:flex-col max-sm:w-fit sm:justify-between'>
                                <DownloadBtn link={"/PDFs/CertificatoEffeImpianti.pdf" as __next_route_internal_types__.RouteImpl<URL>} content="Vedi il certificato" />
                                <DownloadBtn link={"/PDFs/CertificatoSOA.pdf" as __next_route_internal_types__.RouteImpl<URL>} content="Vedi il certificato SOA" />
                            </div>
                        </div>
                    </div>
                </div>
